"""
Script to test LLaVA-NEXT ability to comprehend the broad lines of what is inputed, by asking it to summarize what it sees.
The results are output to a csv, to be manually reviewed.
"""
# IMPORTS
