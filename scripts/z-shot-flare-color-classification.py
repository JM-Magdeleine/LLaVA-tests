...
The RESULTS are put into a json file, containing:
    image_file: image ID within the positive_img directory
    flare_color: predicted color, done according to the procedure
