"""
Script for testing LLaVA-NEXT on zero-shot flare color classification, on 100 labeled images.

Ground truths are loaded from a hand-made json file containing the image ID, flare color and difficulty to tell (majoritarily dictated by its size)

RESULTS are output in a csv file, one for each model, containing columns in the form of:
    imgs: image ID in the positive_img directory
    ground_truths: ground truth color red/blue
    predictions: predicted color red/blue
    gen_times: generation time to generate answer for this image
    difficulties: difficulty to classify the color
"""
